    <div class="flex flex-row flex-wrap gap-4">
                    ...
                    <div class="ml-auto">
                        <span class="flex items-center justify-center space-x-2">
                            <flux:icon.trash class="cursor-pointer"
                                wire:click="deletePanel('{{ $moneyDashboardPanel->id }}')" variant="micro" />
        ...
        @endif
        <div
            class="p-8 w-1/3 h-full hover bg-custom-accent cursor-pointer flex flex-row items-center justify-center gap-2">
