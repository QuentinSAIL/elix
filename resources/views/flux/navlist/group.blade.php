...
>
    <button
        ...
        aria-controls="{{ Str::slug($heading) }}-content"
    >
        <div class="ps-3 pe-4">
    ...
    <div id="{{ Str::slug($heading) }}-content" class="relative hidden space-y-[2px] ps-7 data-open:block" @if ($expanded === true) data-open @endif>
